...
for it in range(10):
    print("hello")
    A_gt = np.loadtxt("data/" + data + "/" + graph + str(s0) + "_d" + str(d) + "/graph/G_" + str(it + 1) + ".txt", delimiter=",")
    A_nll = np.loadtxt("results/"+ data + "/" + graph + str(s0) + "_d" + str(d) + "_n1000_"+data+"/A_formulation1_nll_" + str(it + 1) + ".txt", delimiter=",")
...
for iter in range(10):
    print(iter + 1)
    A_gt = np.loadtxt("data/" + data + "/" + graph + str(s0) + "_d" + str(d) + "/graph/G_" + str(iter + 1) + ".txt", delimiter=",")
    A_notears = np.loadtxt("results/"+ data + "/" + graph + str(s0) + "_d" + str(d) + "_n1000_"+data+"/A_notears_" + str(iter + 1) + ".txt", delimiter=",")
...
#     if data == "homo":
#         A_est = np.loadtxt("/home/naiyu/Desktop/Research/golem/output/homo/" + graph + str(s0) + "_d" + str(d) + "/B_est_" + str(iter + 1) + ".txt", delimiter=",")
#         A_p = np.loadtxt("/home/naiyu/Desktop/Research/golem/output/homo/" + graph + str(s0) + "_d" + str(d) + "/B_processed_" + str(iter + 1) + ".txt", delimiter=",")
#     else:
